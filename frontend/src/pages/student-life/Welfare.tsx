    ...
    const services = [
        {
            ...
            desc: 'Regular health check-ups, first-aid facilities, and guidance on maintaining physical and mental well-being for every student.',
            icon: HeartPulse,
            color: "text-rose-600",
            bg: "bg-rose-50"
        },
        {
            ...
            desc: 'Personal mentoring and counselling help students overcome academic, emotional, and personal challenges.',
            icon: Users,
            color: "text-blue-600",
            bg: "bg-blue-50"
        },
        {
            ...
            desc: 'A disciplined campus with CCTV surveillance, dedicated staff supervision, and a secure learning environment.',
            icon: ShieldCheck,
        ...
        },
        {
            ...
            desc: "Students are encouraged to develop leadership, responsibility, discipline, ethics, and confidence through school activities.",
            icon: GraduationCap,
        ...
        >
            ...
            {/* <motion.div variants={itemVariants} className="space-y-6">
                ...
                <p className="text-gray-500 text-lg lg:text-xl max-w-3xl leading-relaxed font-medium">
                    We prioritize the safety, mental health, and professional growth of our students. SRI SAI VIDYALAYA provides a nurturing environment where every student can thrive.
                </p>
            </motion.div> */}
            ...
            >
                ...
                <div className="space-y-6 relative z-10">
                    ...
                    >
                        At Sri Sai Vidyalaya, student welfare extends beyond academics. We provide a safe, supportive, and caring environment that nurtures physical well-being, emotional health, discipline, character development, and overall personal growth.
                    </motion.p>
                </div>
            </motion.div>
            ...
            <Section className="relative overflow-hidden py-20 lg:py-28 rounded-[60px]">
                ...
                <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
                        {[
                            { title: "SSLC Achievers", path: "/student-life/placement", icon: GraduationCap, desc: "Explore the outstanding SSLC achievements and academic excellence of our students over the years." },
                            { title: "Discipline", path: "/student-life/anti-ragging", icon: ShieldCheck, desc: "School rules, student responsibilities, and expected code of conduct." },
                            { title: "Student Welfare", path: "/student-life", icon: HeartPulse, desc: "Support services for every student's well-being." },
                            { title: "Admissions", path: "/admissions", icon: Sparkles, desc: "Begin your academic journey with Sri Sai Vidyalaya." },
                            { title: "Infrastructure", path: "/infrastructure", icon: Briefcase, desc: "Explore our modern campus and learning facilities." },
                            { title: "Contact Us", path: "/contact", icon: Users, desc: "Reach out to our admissions and support team." },
                        ].map((item, i) => (
                ...
                <div className="relative z-10 flex flex-col lg:flex-row gap-12 items-center">
                    <div className="flex-1 space-y-8 text-center lg:text-left">
                        ...
                        <h2 className="text-4xl lg:text-6xl text-blue-100 tracking-tight leading-[1.1] italic uppercase">
                            ...
                            <span className="text-brand-gold italic">Every Student</span>
                        </h2>
                        <p className="text-gray-400 text-lg lg:text-xl leading-relaxed max-w-2xl font-medium">
                            Our commitment is to create a nurturing environment where every student feels safe, respected, supported, and inspired to achieve academic excellence while developing strong values and lifelong confidence.
                        </p>
                    </div>
                </div>
            </motion.div>
