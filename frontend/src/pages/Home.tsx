...
const galleryItems = [
    ...
    { image: "/other-campus/campus-12.jpeg", text: "A Grade Achievement" },
]
                        ...
                        <div className="container mx-auto px-6 lg:px-12">
                            ...
                            >
                                <motion.div variants={itemVariants} className="flex items-center gap-3">
                                    ...
                                    <p className="text-brand-gold font-black text-[10px] tracking-[0.4em] uppercase font-display italic">Excellence in School Education</p>
                                </motion.div>
                                ...
                                <motion.h1 variants={itemVariants} className="text-2xl md:text-4xl lg:text-6xl font-black font-display leading-[1.1] text-white italic uppercase tracking-tighter">
                                    <BlurText text="Building" delay={150} animateBy="words" />
                                    <br />
                                    <span className="text-brand-gold">Bright Futures</span>
                                </motion.h1>
                        ...
                        >
                            <div className="w-full lg:w-1/2 space-y-8 order-2 lg:order-1">
                                <motion.div variants={itemVariants} className="space-y-4 text-center lg:text-left">
                                    <p className="text-blue-600 font-black text-xs tracking-[0.3em] uppercase">Why Choose SRI SAI VIDYALAYA?</p>
                            ...
                            <motion.div variants={itemVariants} className="w-full lg:w-1/2 relative order-1 lg:order-2 px-4 lg:px-0 flex justify-center items-center">
                                <TiltedCard
                                    ...
                                    altText="SRI SAI VIDYALAYA Students"
                ...
                <section className="relative py-16 md:py-24 overflow-hidden">
                    ...
                    <div className="container relative z-10 mx-auto px-6">
                        ...
                        >
                            ...
                            <motion.h2 variants={itemVariants} className="text-3xl md:text-6xl font-black text-brand-navy drop-shadow-[0_2px_2px_rgba(255,255,255,0.6)] italic">Our <span className="text-brand-gold">Academic</span> Sections</motion.h2>
                        </motion.div>
                            ...
                            {[
                                {
                                    ...
                                    desc: 'Providing a joyful, activity-based learning environment that builds curiosity, creativity, and confidence in young learners.',
                                    icon: BookOpen,
                                    color: 'gold'
                                },
                                {
                                    title: 'Lower & Higher Primary School',
                                    desc: 'Developing strong academic foundations while nurturing discipline, values, creativity, and overall personality development.',
                                    icon: GraduationCap,
                                    color: 'gold'
                                },
                                {
                                    title: 'High School',
                                    desc: 'Preparing students with academic excellence, leadership qualities, and life skills for higher education and future success.',
                                    icon: Award,
                                    color: 'gold'
                                },
                            ].map((p, idx) => (
                    ...
                    <div className="container relative z-10 mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                            ...
                            {[
                                {
                                    title: "About Us",
                                    desc: "Learn about our history, vision, mission, and values",
                                    icon: Info,
                                    link: "/about"
                                },
                                {
                                    title: "Admissions",
                                    desc: "Admission information and enrollment process",
                                    icon: GraduationCap,
                                    link: "/admissions"
                                },
                                {
                                    title: "Campus",
                                    desc: "Explore our classrooms, facilities, and learning environment",
                                    icon: Building2,
                                    link: "/infrastructure"
                                },
                                {
                                    title: "Faculty",
                                    desc: "Meet our dedicated and experienced teachers",
                                    icon: Users,
                                    link: "/faculty"
                                },
                                {
                                    title: "Non-Academics",
                                    desc: "Sports, cultural activities, clubs, and student development",
                                    icon: Briefcase,
                                    link: "/non-academics"
                                },
                                {
                                    title: "Student Life",
                                    desc: "Student welfare, guidance, and holistic growth",
                                    icon: Heart,
                                    link: "/student-life"
                                },
                            ].map((item, index) => (
