...
const Bca = () => {
    const missionItems = [
        "Provide quality primary education through interactive and child-friendly teaching methods.",
        "Encourage curiosity, creativity, and independent thinking.",
        "Foster discipline, moral values, and respect for others.",
        "Support every child's intellectual, emotional, social, and physical development.",
        "Build strong communication, problem-solving, and life skills."
    ];

    const objectives = [
        "Develop strong reading, writing, speaking, and listening skills.",
        "Build a solid foundation in Mathematics and Environmental Studies.",
        "Encourage creativity through art, music, storytelling, and activities.",
        "Promote teamwork, communication, and leadership qualities.",
        "Develop critical thinking and problem-solving abilities.",
        "Foster confidence, discipline, responsibility, and respect for others."
    ];

    const careers = [
        "Reading Skills", "Writing Skills", "Numeracy", "Communication",
        "Creativity", "Critical Thinking", "Teamwork", "Leadership"
    ];
            ...
            <div className="space-y-12 py-6 max-w-6xl mx-auto">
                ...
                >
                    ...
                    <div className="space-y-6 relative z-10">
                        <motion.div variants={itemVariants} className="flex items-center gap-3">
                            ...
                            <p className="text-brand-navy font-black text-xs tracking-[0.4em] uppercase font-display italic">Primary Education</p>
                        </motion.div>
                        <motion.h1 variants={itemVariants} className="text-3xl lg:text-5xl font-black font-display text-brand-navy leading-tight tracking-tight italic">
                            Lower <span className="text-brand-gold">Primary</span> School
                        </motion.h1>
                        <motion.div variants={itemVariants} className="flex flex-wrap gap-3">
                            <span className="px-4 py-1.5 bg-blue-50 text-blue-700 text-[10px] font-black uppercase tracking-widest rounded-full border border-blue-100 italic">Child-Centered Learning</span>
                            <span className="px-4 py-1.5 bg-gray-50 text-gray-600 text-[10px] font-black uppercase tracking-widest rounded-full border border-gray-100 italic">Classes I – IV</span>
                        </motion.div>
                        <motion.p variants={itemVariants} className="text-slate-600 text-sm lg:text-base leading-relaxed max-w-5xl font-medium  font-display">
                            The Lower Primary School at SRI SAI VIDYALAYA provides a strong academic foundation through engaging, activity-based learning. We focus on developing literacy, numeracy, communication, creativity, discipline, and moral values while nurturing every child's confidence and curiosity in a joyful learning environment.
                        </motion.p>
                    </div>
                </motion.div>
                    ...
                    >
                        ...
                        <div className="relative z-10 space-y-6">
                            ...
                            <p className="text-white text-xs lg:text-sm leading-relaxed font-bold italic font-display">
                                To build a strong educational foundation where every child develops confidence, curiosity, creativity, discipline, and a lifelong love for learning in a caring and supportive environment.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <div className="bg-brand-navy text-white rounded-[2rem] p-8 lg:p-12 overflow-hidden relative border-b-[12px] border-brand-gold shadow-2xl">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center space-y-10">
                            <div className="space-y-4">
                                ...
                                <motion.h2 variants={itemVariants} className="text-2xl lg:text-4xl font-black font-display tracking-tight uppercase italic text-blue-100">Learning <span className="text-brand-gold">Outcomes</span></motion.h2>
                                <motion.p variants={itemVariants} className="text-slate-400 text-sm text-white font-black  max-w-3xl mx-auto font-display">
                                    Our Lower Primary program equips children with the academic skills, confidence, values, and curiosity required for successful progression into Higher Primary education.
                                </motion.p>
                            </div>
                ...
                >
                    ...
                    <div className="space-y-4 text-center max-w-2xl">
                        ...
                        >
                            Begin Your Child's <span className="text-brand-gold">Learning</span> Journey
                        </motion.h3>
                        ...
                        >
                            Join the Lower Primary School at SRI SAI VIDYALAYA and provide your child with a nurturing environment that inspires learning, creativity, confidence, and lifelong success.
                        </motion.p>
                    </div>
