    ...
    const courses = [
        {
            ...
            icon: BookOpen,
            path: '/academics/puc',
            desc: 'A joyful, activity-based learning environment that builds curiosity, creativity, confidence, and strong foundational skills during the early years.',
            color: 'bg-white',
            iconColor: 'text-brand-gold'
        },
        {
            title: 'Lower Primary School',
            subtitle: 'Classes I to IV',
            icon: GraduationCap,
            path: '/academics/bca',
            desc: 'Developing essential academic skills, values, creativity, and confidence through engaging and child-friendly learning experiences.',
            color: 'bg-white',
            iconColor: 'text-brand-gold'
        },
        {
            title: 'Higher Primary School',
            subtitle: 'Classes V to VII',
            icon: ShieldCheck,
            path: '/academics/bcom',
            desc: 'Strengthening conceptual understanding, critical thinking, leadership, and overall personality development in a supportive environment.',
            color: 'bg-white',
            iconColor: 'text-brand-gold'
        },
        {
            title: 'High School',
            subtitle: 'Classes VIII to X',
            icon: BarChart3,
            path: '/academics/bcom-data-analytics',
            desc: 'Preparing students for academic excellence, board examinations, leadership, and future educational opportunities with confidence.',
            color: 'bg-white',
            iconColor: 'text-brand-gold'
        }
    ];
                ...
                >
                    ...
                    <div className="space-y-6 relative z-10">
                        <motion.div variants={itemVariants} className="flex items-center gap-3">
                            ...
                            <p className="text-brand-navy font-black text-xs tracking-[0.4em] uppercase font-display italic">SRI SAI VIDYALAYA</p>
                        </motion.div>
                        <motion.h1 variants={itemVariants} className="text-3xl lg:text-5xl font-black font-display text-brand-navy leading-tight tracking-tight italic">
                            Academic <span className="text-brand-gold">Journey</span>
                        </motion.h1>
                        <motion.div variants={itemVariants} className="flex flex-wrap gap-3">
                            <div className="flex items-center gap-2 px-5 py-2 bg-blue-50 border border-blue-100 rounded-full shadow-sm">
                                ...
                                <span className="text-[10px] font-black text-gray-700 uppercase tracking-widest italic font-display">Holistic Learning</span>
                            </div>
                            <div className="flex items-center gap-2 px-5 py-2 bg-gray-50 border border-gray-100 rounded-full shadow-sm">
                                <Sparkles className="h-4 w-4 text-amber-500" />
                                <span className="text-[10px] font-black text-gray-700 uppercase tracking-widest italic font-display">Student Centric</span>
                            </div>
                        </motion.div>
                        <motion.p variants={itemVariants} className="text-slate-600 text-sm lg:text-base leading-relaxed max-w-4xl font-medium  font-display">
                            At SRI SAI VIDYALAYA, we provide a progressive learning journey that nurtures curiosity, knowledge, discipline, creativity, and character from early childhood through high school. Every stage of education is designed to help students grow into confident, responsible, and lifelong learners.
                        </motion.p>
                    </div>
                </motion.div>
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-center gap-16">
                        <div className="flex-1 space-y-10">
                            ...
                            <div className="space-y-6">
                                <motion.h2 variants={itemVariants} className="text-3xl lg:text-5xl font-black font-display tracking-tight leading-tight uppercase text-white italic">Our Learning <br /><span className="text-brand-gold">Philosophy</span></motion.h2>
                                <motion.p variants={itemVariants} className="text-blue-100/80 text-sm lg:text-base font-bold leading-relaxed max-w-4xl  font-display">
                                    At SRI SAI VIDYALAYA, we believe education extends beyond textbooks. Our learning philosophy focuses on academic excellence, moral values, discipline, creativity, and holistic development. We strive to create a safe and inspiring environment where every student is encouraged to discover their potential and prepare confidently for the future.
                                </motion.p>
                            </div>
                        </div>
                        ...
                        <div className="w-full lg:w-auto flex flex-col items-center lg:items-end gap-10">
                            <motion.div variants={itemVariants} className="text-center lg:text-right space-y-2">
                                ...
                                <p className="text-[10px] font-black text-blue-200 tracking-[0.4em] uppercase font-display  opacity-60">Student Success</p>
                            </motion.div>
