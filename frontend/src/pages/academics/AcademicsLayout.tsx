...
const AcademicsLayout = () => {
    const navItems = [
        ...
        { path: "/academics/puc", label: "Montessori School", icon: GraduationCap },
        { path: "/academics/bca", label: "Lower Primary School", icon: GraduationCap },
        { path: "/academics/bcom", label: "Higher Primary School", icon: GraduationCap },
        { path: "/academics/bcom-data-analytics", label: "High School", icon: GraduationCap },
    ];
                ...
                <div className="sticky top-24 space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <h2 className="font-black text-[15px] text-white tracking-tight font-display italic uppercase whitespace-nowrap">
                            ACADEMIC <span className="text-brand-gold">SECTIONS</span>
                        </h2>
                    </div>
