...
const Bcom = () => {
    const objectives = [
        "Strengthen conceptual understanding in Mathematics, Science, English, and Social Studies.",
        "Develop analytical thinking, creativity, and problem-solving abilities.",
        "Enhance communication, teamwork, and leadership skills.",
        "Encourage independent learning and responsible decision-making.",
        "Promote moral values, discipline, environmental awareness, and social responsibility."
    ];
            ...
            <div className="space-y-12 py-6 max-w-6xl mx-auto">
                ...
                >
                    ...
                    <div className="space-y-6 relative z-10">
                        <motion.div variants={itemVariants} className="flex items-center gap-3">
                            ...
                            <p className="text-brand-navy font-black text-xs tracking-[0.4em] uppercase font-display italic">Higher Primary Education</p>
                        </motion.div>
                        <motion.h1 variants={itemVariants} className="text-3xl lg:text-5xl font-black font-display text-brand-navy leading-tight tracking-tight italic">
                            Higher <span className="text-brand-gold">Primary</span> School
                        </motion.h1>
                        <motion.div variants={itemVariants} className="flex flex-wrap gap-3">
                            <span className="px-4 py-1.5 bg-blue-50 text-blue-700 text-[10px] font-black uppercase tracking-widest rounded-full border border-blue-100 italic">Holistic Learning</span>
                            <span className="px-4 py-1.5 bg-gray-50 text-gray-600 text-[10px] font-black uppercase tracking-widest rounded-full border border-gray-100 italic">Classes V – VII</span>
                        </motion.div>
                        <motion.p variants={itemVariants} className="text-slate-600 text-sm lg:text-base leading-relaxed max-w-5xl font-medium  font-display">
                            The Higher Primary School at SRI SAI VIDYALAYA provides a balanced education that strengthens academic knowledge, critical thinking, creativity, discipline, and leadership. We encourage students to become confident learners through interactive classroom experiences, practical activities, and value-based education.
                        </motion.p>
                    </div>
                </motion.div>
                    ...
                    >
                        ...
                        <div className="relative z-10 space-y-6">
                            ...
                            <p className="text-blue-100 text-xs lg:text-sm leading-relaxed font-bold italic font-display">
                                To nurture confident, responsible, and independent learners by providing quality education that promotes academic excellence, creativity, moral values, discipline, and lifelong learning.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="relative z-10 space-y-6">
                            ...
                            <p className="text-slate-600 text-xs lg:text-sm leading-relaxed font-bold italic font-display">
                                To provide a student-centered learning environment that encourages curiosity and creativity. To strengthen conceptual understanding across all subjects through engaging classroom experiences. To promote discipline, teamwork, leadership, and social responsibility. To encourage participation in academics, sports, cultural, and co-curricular activities. To prepare students with the knowledge, confidence, and values needed for secondary education.
                            </p>
                        </div>
                    </motion.div>
                </motion.div>
                    ...
                    <div className="bg-brand-navy text-white rounded-[2rem] p-8 lg:p-12 overflow-hidden relative border-b-[12px] border-brand-gold shadow-2xl">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center space-y-10">
                            <div className="space-y-4">
                                ...
                                <motion.h2 variants={itemVariants} className="text-2xl lg:text-4xl font-black font-display tracking-tight uppercase italic text-center text-blue-100">Student <span className="text-brand-gold">Development</span></motion.h2>
                                <motion.p variants={itemVariants} className="text-slate-400 text-sm lg:text-base font-black italic max-w-4xl mx-auto font-display">
                                    Our Higher Primary program focuses on the overall development of every child by strengthening academic skills, character, leadership, creativity, and confidence to prepare them for High School.
                                </motion.p>
                            </div>

                            <div className="flex flex-wrap justify-center gap-3">
                                {["Academic Excellence", "Critical Thinking", "Communication Skills", "Leadership", "Teamwork", "Creativity", "Discipline", "Character Building"].map((role, idx) => (
                                    <motion.span
                                        key={idx}
                                        variants={itemVariants}
                ...
                >
                    ...
                    <div className="space-y-4 text-center max-w-2xl">
                        ...
                        >
                            Continue Your <span className="text-brand-gold">Learning Journey</span>
                        </motion.h3>
                        ...
                        >
                            Join the Higher Primary School at SRI SAI VIDYALAYA and help your child build strong academic foundations, confidence, leadership, and values for future success.
                        </motion.p>
                    </div>
