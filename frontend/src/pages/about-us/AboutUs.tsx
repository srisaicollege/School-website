                        ...
                        <motion.div variants={itemVariants} className="lg:w-1/2 space-y-8">
                            ...
                            <div className="space-y-6">
                                <p className="text-slate-600 leading-relaxed text-sm lg:text-base font-medium">
                                    SRI SAI VIDYALAYA has been a cornerstone of academic excellence in Bangalore. We believe in holistic development, combining rigorous curriculum with practical exposure to empower students as global leaders of tomorrow.
                                </p>
                                <p className="text-slate-600 leading-relaxed text-sm lg:text-base font-medium">
                            ...
                            <motion.div variants={itemVariants} className="space-y-8">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-slate-500 font-bold uppercase tracking-widest text-xs">Principal, SRI SAI VIDYALAYA</div>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
