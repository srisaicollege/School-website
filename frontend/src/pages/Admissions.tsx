...
const steps = [
    {
        step: "01",
        title: "Inquiry",
        desc: "Contact our admission office to learn about the school, available classes, facilities, and the admission process.",
        icon: HelpCircle
    },
    {
        step: "02",
        title: "Application",
        desc: "Submit the completed admission form along with the required documents for verification.",
        icon: FileText
    },
    {
        step: "03",
        title: "Interaction",
        desc: "Students and parents may have a brief interaction with the school administration to understand the child's educational needs.",
        icon: UserCheck
    },
    {
        step: "04",
        title: "Admission Confirmation",
        desc: "Complete the admission formalities and confirm your child's enrollment at SRI SAI VIDYALAYA.",
        icon: GraduationCap
    }
];
            ...
            <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-12 lg:py-16 space-y-16 lg:space-y-24">
                ...
                >
                    ...
                    <div className="space-y-5 max-w-3xl mx-auto lg:mx-0 text-center lg:text-left">
                        ...
                        >
                            Admissions at SRI SAI VIDYALAYA are conducted in a transparent and student-friendly manner. We welcome students into a safe, nurturing, and inspiring learning environment where academic excellence, discipline, and holistic development are our highest priorities.
                        </motion.p>
                ...
                >
                    ...
                    <div className="relative z-10 space-y-5">
                        ...
                        <p className="text-blue-100 text-sm lg:text-base leading-relaxed font-medium font-display max-w-2xl">
                            Parents are requested to carefully review the admission guidelines, eligibility requirements, and required documents before submitting the admission application. Our admission team is available to assist throughout the process.
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                            ...
                            >
                                ...
                                <div className="space-y-3">
                                    <h4 className="flex items-center gap-2 text-[10px] font-black text-brand-navy uppercase tracking-[0.3em] italic">
                                        Montessori to Higher Primary
                                    </h4>

                                    <p className="text-slate-600 text-sm lg:text-lg font-bold leading-relaxed italic font-display">
                                        Admissions are open for Montessori, Lower Primary, and Higher Primary based on the student's age and previous academic records where applicable.
                                    </p>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="text-slate-600 text-sm lg:text-lg font-bold leading-relaxed italic font-display">
                                        Admissions to High School are based on successful completion of the previous class and submission of the required academic records and transfer certificate, as applicable.
                                    </p>
                                </div>
                            </motion.div>
                        </div>
                ...
                >
                    <div className="space-y-8 text-center lg:text-left">
                        ...
                        >
                            Join SRI SAI VIDYALAYA and become part of a learning community committed to academic excellence, character building, discipline, creativity, and holistic development.
                        </motion.p>
