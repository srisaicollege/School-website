                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 relative z-10 items-start">
                                ...
                                >
                                    ...
                                    <div className="space-y-2 relative z-10">
                                        <h3 className="text-xl lg:text-2xl font-black text-brand-navy italic tracking-tight">Admission <span className="text-brand-gold">Inquiry</span></h3>
                                        <p className="text-xs text-slate-500 font-bold italic opacity-80">Our admissions team will respond as soon as possible.</p>
                                    </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                >
                                                    ...
                                                    <option value="Higher Primary School">Higher Primary School</option>
                                ...
                                <div className="space-y-10 order-2 lg:order-2 lg:py-4">
                                    <motion.div variants={itemVariants} className="space-y-6">
                                        ...
                                        <p className="text-slate-600 text-sm leading-relaxed font-semibold italic opacity-90 max-w-md">
                                            Have questions about admissions, academics, or school activities? Our team is here to assist you and provide all the information you need.
                                        </p>
                                    </motion.div>
                                    ...
                                    <div className="grid gap-6">
                                        {[
                                            ...
                                            { icon: Mail, title: "Email", value: <>srisaividyalaya2017@gmail.com</> },
                                            { icon: Clock, title: "Hours", value: <>Monday – Saturday<br />9:00 AM – 5:00 PM</> }
                                        ].map((item, idx) => (
                                            <motion.div
                                                key={idx}
                                                variants={itemVariants}
